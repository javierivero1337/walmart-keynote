...
const palette = {
  ...
  borderBright: 'rgba(0,255,135,0.32)',
  accentSoft: '#8affc1',
  accent2: '#64d2ff',
  mint: '#00ff87',
  amber: '#ffb84d',
  inspect: '#64d2ff',
  inspectFill: 'rgba(100,210,255,0.12)',
};
  ...
  <div
    style={{
      ...
      backgroundImage: `
        ...
        radial-gradient(circle at 18% 12%, rgba(0,255,135,0.13), transparent 34%),
        radial-gradient(circle at 88% 84%, rgba(100,210,255,0.10), transparent 36%)
      `,
      backgroundSize: '96px 96px',
      maskImage: 'radial-gradient(ellipse at center, rgba(0,0,0,0.96) 0%, rgba(0,0,0,0.72) 46%, rgba(0,0,0,0) 78%)',
      WebkitMaskImage: 'radial-gradient(ellipse at center, rgba(0,0,0,0.96) 0%, rgba(0,0,0,0.72) 46%, rgba(0,0,0,0) 78%)',
    }}
  />
);
...
const Eyebrow = ({
  ...
  <div
    ...
    style={{
      ...
      textShadow: `0 0 22px ${palette.accent}22`,
      ...style,
    }}
  >
    {children}
...
const WindowShell = ({
  ...
  <div
    style={{
      ...
      boxShadow: '0 44px 90px -48px rgba(0,0,0,0.95), 0 0 0 1px rgba(0,255,135,0.035)',
      overflow: 'hidden',
      display: 'flex',
...
const LogoCard = ({
  ...
  <div
    ...
    style={{
      ...
      gap: 28,
      minHeight: 0,
      boxShadow: '0 34px 80px -52px rgba(0,0,0,0.95)',
    }}
  >
    <div
      style={{
  ...
  >
    <div
      style={{
        ...
        justifyContent: 'center',
        background:
          'repeating-conic-gradient(rgba(255,255,255,0.08) 0deg 90deg, transparent 90deg 180deg) 0 0 / 16px 16px',
      }}
    >
